...
4. After installation, open the Apps list on your hub and launch **Advanced Heliotrope** to begin configuration.
...
3. From **Apps**, click **Add User App** and select **Advanced Heliotrope**.
